...
def create(**actions):
  ...
  S_authenticate.set_events([EVENT('sent',[]),EVENT('packet',[actions['parse_auth_response']]),EVENT('done',[], S_connected),EVENT('password',[], S_password),EVENT('query',[]),EVENT('close',[], S_close),])
  S_password.set_events([EVENT('sent',[]),EVENT('packet',[actions['parse_password_response']]),EVENT('done',[], S_connected),EVENT('query',[]),EVENT('close',[], S_close),])
  ...
  S_close.set_events([])
  return FSM([S_init,S_greeting,S_authenticate,S_password,S_connected,S_query,S_query_descriptors,S_query_fields,S_close])
