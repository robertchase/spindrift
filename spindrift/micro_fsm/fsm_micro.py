...
def create(**actions):
  ...
  S_route.set_events([EVENT('type',[actions['add_arg']]),EVENT('get',[], S_method),EVENT('post',[], S_method),EVENT('put',[], S_method),EVENT('delete',[], S_method),])
  S_method.set_events([EVENT('content',[actions['add_content']]),EVENT('get',[actions['add_method']]),EVENT('post',[actions['add_method']]),EVENT('put',[actions['add_method']]),EVENT('delete',[actions['add_method']]),EVENT('config',[actions['add_config']]),EVENT('server',[], S_server),EVENT('route',[], S_route),EVENT('connection',[], S_connection),EVENT('database',[], S_database),EVENT('setup',[], S_setup),EVENT('teardown',[], S_teardown),EVENT('log',[], S_log),])
