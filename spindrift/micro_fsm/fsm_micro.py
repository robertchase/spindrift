...
def create(**actions):
  ...
  S_init.set_events([EVENT('server',[], S_server),EVENT('connection',[], S_connection),EVENT('config',[actions['add_config']]),EVENT('setup',[actions['add_setup']]),EVENT('teardown',[actions['add_teardown']]),EVENT('database',[actions['add_database']]),])
  S_server.set_events([EVENT('route',[], S_route),EVENT('server',[actions['add_server']]),EVENT('config',[actions['add_config']]),EVENT('connection',[], S_connection),EVENT('setup',[actions['add_setup']]),EVENT('teardown',[actions['add_teardown']]),EVENT('database',[actions['add_database']]),])
  S_route.set_events([EVENT('get',[actions['add_method']]),EVENT('post',[actions['add_method']]),EVENT('put',[actions['add_method']]),EVENT('delete',[actions['add_method']]),EVENT('route',[actions['add_route']]),EVENT('config',[actions['add_config']]),EVENT('server',[], S_server),EVENT('connection',[], S_connection),EVENT('setup',[actions['add_setup']]),EVENT('teardown',[actions['add_teardown']]),EVENT('database',[actions['add_database']]),])
  S_connection.set_events([EVENT('connection',[actions['add_connection']]),EVENT('config',[]),EVENT('header',[actions['add_header']]),EVENT('resource',[], S_resource),EVENT('server',[], S_server),EVENT('setup',[actions['add_setup']]),EVENT('teardown',[actions['add_teardown']]),EVENT('database',[actions['add_database']]),])
